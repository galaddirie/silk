...
if TYPE_CHECKING:
    ...
    from silk.models.browser import (
        NavigationOptions, WaitOptions, ClickOptions, TypeOptions, MouseMoveOptions,
        DragOptions, KeyPressOptions, MouseButtonLiteral, CoordinateType
    )
...
class BrowserPage:
    ...
    async def click(self, selector: str, options: Optional['ClickOptions'] = None) -> Result[None, Exception]:
        return await self.driver.click(self.id, selector, options)
    
    async def fill(self, selector: str, value: str, options: Optional['TypeOptions'] = None) -> Result[None, Exception]:
        return await self.driver.fill(self.id, selector, value, options)
        
    async def double_click(self, selector: str, options: Optional['ClickOptions'] = None) -> Result[None, Exception]:
        """Double click on an element"""
        return await self.driver.double_click(self.id, selector, options)
    
    async def type(self, selector: str, text: str, options: Optional['TypeOptions'] = None) -> Result[None, Exception]:
        """Type text into an element"""
        return await self.driver.type(self.id, selector, text, options)
    
    async def select(self, selector: str, value: Optional[str] = None, text: Optional[str] = None) -> Result[None, Exception]:
...
class BrowserContext:
    ...
    async def create_page(self, nickname: Optional[str] = None) -> Result[BrowserPage, Exception]:
    ...
    async def mouse_down(
        self, button: 'MouseButtonLiteral' = "left", options: Optional['MouseMoveOptions'] = None
    ) -> Result[None, Exception]:
